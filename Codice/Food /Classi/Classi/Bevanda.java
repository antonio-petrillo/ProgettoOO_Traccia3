...
public class Bevanda extends Prodotto {
	...
	public Bevanda(String nome, double prezzo, String codiceSeriale, String descrizione, Date scadenzaProdotto,
			String bevandeTipo, String bevandeDescrizione, double bevandeCosto) {
