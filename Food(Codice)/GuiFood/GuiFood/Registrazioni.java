...
public  class Registrazioni extends JDialog implements ActionListener{
	...
	private JTextField textField_Password;	
	 public Registrazioni(final Controller ctrl) {
		...
		Label_Provincia.setBounds(66, 224, 61, 16);
		textField_Iscrizione.add(Label_Provincia);
		
		JLabel lbIconaProvincia = new JLabel("");
		lbIconaProvincia.setBounds(139, 224, 25, 16);
		...
		separator_Password_1.setBounds(139, 237, 348, 12);
		...
		separator_Password_1_1.setBounds(139, 270, 134, 12);
		...
		separator_Password_1_1_1.setBounds(361, 270, 126, 12);
		...
		separator_Password_1_1_2.setBounds(139, 294, 134, 12);
		...
		textField_NomeVia.setBounds(164, 282, 109, 14);
		...
		Label_NumCivico.setBounds(297, 289, 61, 16);
		textField_Iscrizione.add(Label_NumCivico);
		
		JLabel lbIconaN_Civico = new JLabel("");
		lbIconaN_Civico.setBounds(361, 280, 23, 26);
		...
		separator_Password_1_1_1_1.setBounds(361, 298, 126, 12);
